    ...
    class FakeAmbientOcclusion : public BASE::Material
    {
     public:
        ...
        virtual CORE::ScatteredRay scatter(const BASE::Intersect &_hit) const override {
            auto color = CORE::Color(_hit.m_uMarchDepth*0.001f + 0.5,
                                     _hit.m_uMarchDepth*0.001f + 0.5,
                                     _hit.m_uMarchDepth*0.001f + 0.5,
    ...
    class Glow : public BASE::Material
    {
     public:
        ...
        virtual CORE::ScatteredRay scatter(const BASE::Intersect &_hit) const override {
            ...
            auto glow = (CORE::Color(1.0f, 0.0f, 0.0f) - CORE::Color(0.055f, 0.0f, 0.0f) * _hit.m_uMarchDepth).clamp() * 10;
